...
var createRouter = function (opt) {
    ...
    var router = {
        ...
        _getOptions: function () { return (__assign(__assign({}, options), { basePath: cleanBasePath, engine: undefined })); },
        // @ts-ignore
...
function compose() {
    ...
    if (funcs.length === 0) {
        return function (arg) { return arg; }; // eslint-disable-line @typescript-eslint/no-explicit-any
    }
    if (funcs.length === 1) {
        return funcs[0];
    }
